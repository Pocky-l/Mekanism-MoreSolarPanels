...
public abstract class TileEntityBigSolarGenerator extends TileEntitySolarGenerator implements IEvaporationSolar {
    ...
    public TileEntityBigSolarGenerator(Holder<Block> blockProvider, BlockPos pos, BlockState state, @NotNull LongSupplier maxOutput) {
