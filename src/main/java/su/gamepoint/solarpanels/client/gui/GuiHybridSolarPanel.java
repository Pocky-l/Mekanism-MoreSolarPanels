...
import su.gamepoint.solarpanels.tiles.panels.HybridSolarPanelTile;
 ...
 * @author Dudko Roman
 */
public class GuiHybridSolarPanel<TILE extends HybridSolarPanelTile> extends GuiMekanismTile<TILE, MekanismTileContainer<TILE>> {

    public GuiHybridSolarPanel(MekanismTileContainer<TILE> container, Inventory inv, Component title) {
    ...
    protected void addGuiElements() {
        ...
        HybridSolarPanelTile var10006 = this.tile;
