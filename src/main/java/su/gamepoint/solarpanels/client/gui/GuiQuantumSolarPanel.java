...
import su.gamepoint.solarpanels.tiles.panels.QuantumSolarPanelTile;
 ...
 * @author Dudko Roman
 */
public class GuiQuantumSolarPanel<TILE extends QuantumSolarPanelTile> extends GuiMekanismTile<TILE, MekanismTileContainer<TILE>> {

    public GuiQuantumSolarPanel(MekanismTileContainer<TILE> container, Inventory inv, Component title) {
    ...
    protected void addGuiElements() {
        ...
        QuantumSolarPanelTile var10006 = this.tile;
