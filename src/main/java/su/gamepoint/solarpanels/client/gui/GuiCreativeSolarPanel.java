...
import su.gamepoint.solarpanels.tiles.panels.CreativeSolarPanelTile;
 ...
 * @author Dudko Roman
 */
public class GuiCreativeSolarPanel<TILE extends CreativeSolarPanelTile> extends GuiMekanismTile<TILE, MekanismTileContainer<TILE>> {

    public GuiCreativeSolarPanel(MekanismTileContainer<TILE> container, Inventory inv, Component title) {
    ...
    protected void addGuiElements() {
        ...
        CreativeSolarPanelTile var10006 = this.tile;
