...
import su.gamepoint.solarpanels.tiles.panels.PhotonicSolarPanelTile;
 ...
 * @author Dudko Roman
 */
public class GuiPhotonicSolarPanel<TILE extends PhotonicSolarPanelTile> extends GuiMekanismTile<TILE, MekanismTileContainer<TILE>> {

    public GuiPhotonicSolarPanel(MekanismTileContainer<TILE> container, Inventory inv, Component title) {
    ...
    protected void addGuiElements() {
        ...
        PhotonicSolarPanelTile var10006 = this.tile;
