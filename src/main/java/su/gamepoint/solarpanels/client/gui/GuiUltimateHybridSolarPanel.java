...
import su.gamepoint.solarpanels.tiles.panels.UltimateHybridSolarPanelTile;
...
public class GuiUltimateHybridSolarPanel<TILE extends UltimateHybridSolarPanelTile> extends GuiMekanismTile<TILE, MekanismTileContainer<TILE>> {
    ...
    public GuiUltimateHybridSolarPanel(MekanismTileContainer<TILE> container, Inventory inv, Component title) {
    ...
    protected void addGuiElements() {
        ...
        UltimateHybridSolarPanelTile var10006 = this.tile;
