...
import su.gamepoint.solarpanels.tiles.panels.AdvancedSolarPanelTile;
 ...
 * @author Dudko Roman
 */
public class GuiAdvancedSolarPanel<TILE extends AdvancedSolarPanelTile> extends GuiMekanismTile<TILE, MekanismTileContainer<TILE>> {

    public GuiAdvancedSolarPanel(MekanismTileContainer<TILE> container, Inventory inv, Component title) {
    ...
    protected void addGuiElements() {
        ...
        AdvancedSolarPanelTile var10006 = this.tile;
