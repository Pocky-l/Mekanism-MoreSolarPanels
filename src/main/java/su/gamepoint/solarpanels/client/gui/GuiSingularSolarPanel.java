...
import su.gamepoint.solarpanels.tiles.panels.SingularSolarPanelTile;
 ...
 * @author Dudko Roman
 */
public class GuiSingularSolarPanel<TILE extends SingularSolarPanelTile> extends GuiMekanismTile<TILE, MekanismTileContainer<TILE>> {

    public GuiSingularSolarPanel(MekanismTileContainer<TILE> container, Inventory inv, Component title) {
    ...
    protected void addGuiElements() {
        ...
        SingularSolarPanelTile var10006 = this.tile;
