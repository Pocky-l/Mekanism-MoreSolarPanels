...
public abstract class AbstractSolarPanel extends TileEntityGenerator {
    ...
    @Nullable
    protected AbstractSolarPanel.SolarCheck solarCheck;
    ...
    protected void recheckSettings() {
        if (this.level != null) {
            this.solarCheck = new AbstractSolarPanel.SolarCheck(this.level, this.worldPosition);
    ...
    protected static class SolarCheck {
        ...
        public void recheckCanSeeSun() {
            this.canSeeSun = this.world != null && world.dimensionType().hasSkyLight() && world.canSeeSky(this.pos);
        }
